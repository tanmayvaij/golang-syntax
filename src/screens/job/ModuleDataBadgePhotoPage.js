...
export default function ModuleDataBadgePhotoPage() {
  ...
  const nextPressed = async () => {
    ...
    EcomHelper.showSuccessMessage("Installed Successfully");
  };
    ...
    <ScrollView style={styles.scrollView}>
      <SafeAreaView style={styles.content}>
        ...
        <View style={styles.body}>
          <Text type={TextType.CAPTION_3}>Set and Seal Photo</Text>
          <View style={styles.spacer} />
          <Text>Photo of meter module data badge</Text>
          {selectedImage && (
            <Image
