...
function RemovedSitePhotoPage() {
  ...
  const nextPressed = async () => {
    ...
    if (
      ...
      navigation.navigate("RemovedAssetTypeSelectionPage");
    }
  };
...
export default RemovedSitePhotoPage;
